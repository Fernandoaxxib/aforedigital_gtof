...
public class CerInaProRepo extends RepoBase{
	...
	public String ejecutarProceso(Integer pOpciones,Date pFechaInicial)throws AforeException {
		try {
			...
			query.registerStoredProcedureParameter("pOpciones", String.class, ParameterMode.IN);
			query.registerStoredProcedureParameter("pFechaInicial", String.class, ParameterMode.IN);
