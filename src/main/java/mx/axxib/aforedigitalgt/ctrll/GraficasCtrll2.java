...
@Scope(value = "session")
@Component(value = "graficasCtrll2")
@ELBeanName(value = "graficasCtrll2")
public class GraficasCtrll2 extends ControllerBase {
...
//        options.setAnimation(animation);
    ...
    public void createBarModel2() {
        ...
        barDataSet2.setLabel("Other Dataset");
    ...
    public void createRadarModel() {
        ...
        radarDataSet2.setLabel("Other Dataset");
