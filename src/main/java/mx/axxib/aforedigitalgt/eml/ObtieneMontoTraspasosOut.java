...
@SqlResultSetMappings({
		@SqlResultSetMapping(name = "ObtieneMontoTraspasosOut", 
				classes = { @ConstructorResult(targetClass = ObtieneMontoTraspasosOut.class, 
				columns = {
...
public class ObtieneMontoTraspasosOut {
