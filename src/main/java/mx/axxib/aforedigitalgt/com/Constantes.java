...
public class Constantes {
	...
	public static final String MOD_DESEMPLEO_PARC_PACKAGE="PKG_RET_FOPROUNI";
	public static final String MOD_DESEMPLEO_PARC_PROCESO_FEC_INI="PRC_PROCESO_FECHA_INICIAL";
	public static final String MOD_DESEMPLEO_PARC_DET_SAL="PRC_PROCESO_BOTON_DETSAL";
	public static final String MOD_DESEMPLEO_PARC_GUARDAR_DET_SAL="PRC_BOTON_GUARDA_DETSAL";
	public static final String MOD_DESEMPLEO_PARC_EJECUTAR_PROCESO="PRC_PROCESO_BOTON_EJECUTAR";
	public static final String MOD_DESEMPLEO_PARC_PROCESAR_REPORTES="PRC_REPORTES_BOTON_PROCESAR";
	public static final String MOD_DESEMPLEO_PARC_LAYOUT_BTN_LOTES="PRC_LAYOUT_BOTON_LOTES";
	public static final String MOD_DESEMPLEO_PARC_LAYOUT_BTN_GENERAR="PRC_LAYOUT_BOTON_GENERAR";
